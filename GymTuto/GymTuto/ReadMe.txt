Step 1: Double Click on GymTuto.sln
Step2 : In the shared folder, copy the database file called "GymDb.mdf" and paste it in your documents
...
SqlConnection Con = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\UserName\Documents\GymDb.mdf;Integrated Security=True;Connect Timeout=30");
